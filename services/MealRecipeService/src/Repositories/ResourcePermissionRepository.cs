...
public class ResourcePermissionRepository : Interfaces.IResourcePermissionRepository
{
    ...
    public ResourcePermissionRepository(MealRecipeDbContext context)
    {
        _context = context;
    }   
...
{
    private readonly MealRecipeDbContext _context; 
    public ResourceTypeRepository(MealRecipeDbContext context)
    {
        _context = context;
    }   
...
{
    private readonly MealRecipeDbContext _context; 
    public SubjectTypeRepository(MealRecipeDbContext context)
    {
        _context = context;
    }   
...
{
    private readonly MealRecipeDbContext _context; 
    public PermissionTypeRepository(MealRecipeDbContext context)
    {
        _context = context;
    }  
